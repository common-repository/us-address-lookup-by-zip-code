 ...
 */
class Pt_Us_Zip_Codes_Public_FF_Zip {
	...
	public function add_field($fields){
		$fields['usz_zip'] = __('US Zip Code', 'usz');
		return $fields;
    }
	...
	public function field_defaults($field_data){
		if ( $field_data['type'] == 'usz_zip' ) {
			$field_data['name'] = 'Zip Code';
	...
	public function show( $field, $field_name, $atts ) {
      ...
      $field['value'] = stripslashes_deep($field['value']);
    	?>
<input type="text" id="usz-zip-field" name="<?php echo esc_attr( $field_name ) ?>"
...
new Pt_Us_Zip_Codes_Public_FF_Zip;