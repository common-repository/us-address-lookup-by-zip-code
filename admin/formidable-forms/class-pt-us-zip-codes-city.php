 ...
 */
class Pt_Us_Zip_Codes_Public_FF_City {
	...
	public function add_field($fields){
		$fields['usz_city'] = __('US City', 'usz');
		return $fields;
    }
	...
	public function field_defaults($field_data){
		if ( $field_data['type'] == 'usz_city' ) {
			$field_data['name'] = 'City';
	...
	public function show( $field, $field_name, $atts ) {
      ...
      $field['value'] = stripslashes_deep($field['value']);
    	?>
<input type="text" id="usz-city-field" name="<?php echo esc_attr( $field_name ) ?>"
...
new Pt_Us_Zip_Codes_Public_FF_City;